                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card settingsCard">
                                <h1 class="red-text text-center">Terms of service</h1>
                                <hr class="sep-bar">
                                <div class="row">
                                    <div class="col-md-12">
                                         
                                         <h3 class="red-text">Overview</h3>
                                         <p class="text-justify">
                                         This website is operated by Winedunk Ltd. Throughout the site, the terms "we", "us" and "our" refer to Winedunk Ltd. Winedunk Ltd offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.<br/><br/>
                                         ...
                                         <h3 class="red-text">Section 1 - Online website terms</h3>
                                         <p class="text-justify">
                                         By agreeing to these Terms of Service, you represent that you are at least the age of majority in your state or province of residence.<br/><br/>
                                         ...
                                         <h3 class="red-text">Section 2 - General conditions</h3>
                                         <p class="text-justify">
                                         We reserve the right to refuse service to anyone for any reason at any time.<br/><br/>
                                         You understand that your content, may be transferred unencrypted and involve (a) transmissions over various networks; and (b) changes to conform and adapt to technical requirements of connecting networks or devices. <br/><br/>
                                         ...
                                         <h3 class="red-text">Section 3 - Accuracy, completeness and timeliness of information</h3>
                                         <p class="text-justify">
                                         ...
                                         <h3 class="red-text">Section 4 - Modification to the service and prices</h3>
                                         <p class="text-justify">
                                         ...
                                         <h3 class="red-text">Section 5 - Products or services (if applicable)</h3>
                                         <p class="text-justify">
                                         ...
                                         <h3 class="red-text">Section 6 - Optional tools</h3>
                                         <p class="text-justify">
                                         ...
                                         <h3 class="red-text">Section 7 - Third-party links</h3>
                                         <p class="text-justify">
                                         ...
                                         <h3 class="red-text">Section 8 - User comments, feedback and other submissions</h3>
                                         <p class="text-justify">
                                         ...
                                         We may, but have no obligation to, monitor, edit or remove content that we determine in our sole discretion are unlawful, offensive, threatening, libellous, defamatory, pornographic, obscene or otherwise objectionable or violates any party's intellectual property or these Terms of Service.<br/><br/>
                                         ...
                                         <h3 class="red-text">Section 9 - Personal information</h3>
                                         <p class="text-justify">
                                         Your submission of personal information through the website is governed by our Privacy Policy. To view our Privacy Policy.<br/><br/>
                                         </p>
                                         
                                         <h3 class="red-text">Section 10 - Errors, inaccuracies and omissions</h3>
                                         <p class="text-justify">
                                         ...
                                         <h3 class="red-text">Section 11 - Prohibited uses</h3>
                                         <p class="text-justify">
                                         ...
                                         <h3 class="red-text">Section 12 - Disclaimer of warranties; Limitation of liability</h3>
                                         <p class="text-justify">
                                         ...
                                         In no case shall Winedunk Ltd, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.<br/><br/>
                                         </p>
                                         
                                         <h3 class="red-text">Section 13 - Identification</h3>
                                         <p class="text-justify">
                                         You agree to indemnify, defend and hold harmless Winedunk Ltd and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.<br/><br/>
                                         </p>
                                         
                                         <h3 class="red-text">Section 14 - Severability</h3>
                                         <p class="text-justify">
                                         ...
                                         <h3 class="red-text">Section 15 - Termination</h3>
                                         <p class="text-justify">
                                         ...
                                         <h3 class="red-text">Section 16 - Entire agreement</h3>
                                         <p class="text-justify">
                                         ...
                                         <h3 class="red-text">Section 17 - Governing law</h3>
                                         <p class="text-justify">
                                         These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of United Kingdom.<br/><br/>
                                         </p>
                                         
                                         <h3 class="red-text">Section 18 - Changes to terms of service</h3>
                                         <p class="text-justify">
                                         ...
                                         <h3 class="red-text">Section 19 - Contact information</h3>
                                         <p class="text-justify">
                                         Questions about the Terms of Service should be sent to us at info@winedunk.com.
                                         </p>
									</div>
                                </div>
                            </div>
