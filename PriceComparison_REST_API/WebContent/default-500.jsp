                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card settingsCard">
                                <h1 class="red-text text-center">Something went wrong!</h1>
                                <hr class="sep-bar">
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>
                                        	We apologise, we did something wrong. We will be working to fix this. Please come back soon, as the error will most likely be gone. In the meanwhile, you may want to go back to <a href="/Home">Home</a>.
                                        </p>
                                    </div>
                                </div>
                            </div>
